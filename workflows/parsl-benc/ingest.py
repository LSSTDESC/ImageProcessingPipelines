...
@bash_app(executors=["worker-nodes"], cache=True, ignore_for_cache=['stdout', 'stderr', 'wrap'])
...
@python_app(executors=["worker-nodes"], cache=True, ignore_for_cache=['stdout', 'stderr'])
