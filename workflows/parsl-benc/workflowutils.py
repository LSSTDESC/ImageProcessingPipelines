def wrap_shifter_container(cmd: str, run_dir: str = "./") -> str:
    ...
    return "echo $(date) wrap-shifter: about to start shifter; shifter --image=lsstdesc/desc-drp-stack:v19-dc2-run2.2-v3 {workflow_src_dir}/container-inner.sh {cwd} {cmd}".format(workflow_src_dir = workflow_src_dir, cmd=cmdfile, cwd=os.getcwd())
