...
# Name of RA column
config.ra_name='raJ2000_smeared'

# Name of Dec column
config.dec_name='decJ2000_smeared'
...
config.mag_err_column_map={'lsst_u_smeared': 'sigma_lsst_u', 'lsst_g_smeared': 'sigma_lsst_g', 'lsst_r_smeared': 'sigma_lsst_r', 'lsst_i_smeared': 'sigma_lsst_i', 'lsst_z_smeared': 'sigma_lsst_z', 'lsst_y_smeared': 'sigma_lsst_y'}
...
config.extra_col_names=['raJ2000', 'decJ2000', 'sigma_raJ2000', 'sigma_decJ2000', 'lsst_u', 'lsst_g', 'lsst_r', 'lsst_i', 'lsst_z', 'lsst_y', 'properMotionRa', 'properMotionDec', 'parallax', 'radialVelocity']
