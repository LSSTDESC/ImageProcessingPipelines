...
cp /pbs/throng/lsst/software/desc/DC2/$RUN/ImageProcessingPipelines/workflows/srs/pipe_setups/checkpoints.sh .
...
export PATH=$PATH:/pbs/throng/lsst/software/desc/DC2/$RUN/ImageProcessingPipelines/workflows/srs/pipe_scripts/
